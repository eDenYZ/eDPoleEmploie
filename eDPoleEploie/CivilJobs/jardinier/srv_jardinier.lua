...
RegisterNetEvent("JardinierAntiDump")
AddEventHandler("JardinierAntiDump", function()
    TriggerClientEvent("JardinierAntiDump", source, config, workzone, WorkerChillPos, WorkerWorkingPos)
end)
